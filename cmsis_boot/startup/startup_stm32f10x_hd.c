...
#define HEAP_SIZE		0x00000800		/* 8k */
__attribute__ ((used,section(".heap")))
unsigned long __heap[HEAP_SIZE];
...
/*----------Function prototypes-----------------------------------------------*/  
extern int init(void);           /*!< The entry point for the application.    */
